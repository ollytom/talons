...
static void textview_create_tags(GtkTextView *text, TextView *textview)
{
	...
	PangoFontDescription *font_desc = default_font();
	PangoFontDescription *bold_font_desc = default_font();
...
{
	fprintf(stderr, "TODO(otl): no-op mail_to_uri_cb called, delete me\n");
}
